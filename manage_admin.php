            ...
            <div class="container-fluid">
                          ...
                          <div class="container">
                            ...
                            <div class="col-lg-12">
                              <div class="panel panel-primary">
                                ...
                                <div class="col-lg-6">
                                  <a href="SignUp.php"><button type="button" class="btn btn btn-success">Add New Admin</button></a>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <td><a href="Edit_admin.php?abc=<?php echo $data['id'] ?>">Edit</br></a></td>
                                <td><a href="delete_admin.php?xyz=<?php echo $data['id']; ?>">Delete</br></a></td>
                                </tr>
                                </tbody>
                                <?php
                                $count++;
