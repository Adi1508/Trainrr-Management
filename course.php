            ...
            <div class="container-fluid">
                          ...
                          <div class="container">
                            ...
                            <div class="col-lg-12">
                              ...
                              <div class="panel panel-primary">
                                ...
                                <div class="col-lg-6">
                                  <a href="addcourse.php"><button type="button" class="btn btn btn-success">Add New Course</button></a>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <td><a href="delete_course.php?xyz=<?php echo $data['id']; ?>">Delete</br></a></td>
                                </tr>
                                </tbody>
                                <?php
                                $count++;
