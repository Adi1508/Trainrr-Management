    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">ADD ENQUIRY</a>
            </div>
            <!-- Top Menu Items -->
        ...
        <div id="page-wrapper">
                             ...
                             <div class="form-group">
                               ...
                               $row=mysql_query($query);
                                 ...
                                 ?>
                                   ...
                                   <option value = <?php $data['centre'] ?>><?php echo $data['centre'] ?></option>
            ...
            if(isset($_POST["submit"]))
            {
              ...
              $query="insert into enquiry set name='$name', fname='$fname', mobile='$mobile', email='$email',
                      courseduration='$coursedur', address='$address', dob='$dob', course='$course', centre='$centre', gender='$gen'";
              $row=mysql_query($query);
              if($row>0)
              {
