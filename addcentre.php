    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">ADD CENTRE</a>
            </div>
            <!-- Top Menu Items -->
                            ...
                            <div class="col-lg-4">
                              <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="panel-heading">
                                  ...
                                  <th><h3 style="text-align:center">Add Centre</h3></th>
                                </div>
                              ...
                              <table class="table table-bordered table-hover table-striped">
                                <tbody align="center">
                                    ...
                                    <h3 style="text-align:center">Centre</h3>
                                    <input class="form-control" name="centre" type="text" autofocus>
                                </div></td></tr>
                                <div class="centered">
...
<!--my7 inserted table-->
                          ...
                          if(isset($_POST["add"]))
                          {
                            ...
                            $query="insert into center set centre='$centre'";
