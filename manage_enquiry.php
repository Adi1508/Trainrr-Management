    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">MANAGE ENQUIRY</a>
            </div>
            <!-- Top Menu Items -->
                        ...
                        <div class="jumbotron">
                          <div class="container">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                      <h2 class="panel-title" align="center">Trainee Enquiry Details</h2>
                                  </div>
                                  <div class="col-lg-6">
                                    <a href="add_enquiry.php"><button type="button" class="btn btn btn-success">Add New Enquiry</button></a>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <td><a href="Edit_trainee.php?abc=<?php echo $data['id'] ?>">Edit</br></a>
                                                <a href="delete_enquiry.php?xyz=<?php echo $data['id']; ?>">Delete</br></a></td>
                                </tr>
                                </tbody>
                                <?php
                                $count++;
